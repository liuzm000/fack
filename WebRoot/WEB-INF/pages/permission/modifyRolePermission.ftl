...
<title>广东移百管理系统-权限管理-修改角色权限</title>
...
<body scroll="auto">
	<form action="${request.contextPath}/system/modifyAdminRolePermission.action" method="post">
			...
			<tr align="center">
				<td colspan="2" bgcolor="#ffffff">
					<INPUT class='denglu1' type='button' value="保存"
						onclick="submitform(this.form,'${role?if_exists.role_name?if_exists}','${request.contextPath}/system/modifyAdminRolePermission.action')"/>
