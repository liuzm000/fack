...
function checkForm(){
	var title = document.getElementById("wallpaper.title");
	var price = document.getElementById("wallpaper.price");
	var phoneId = document.getElementById("wallpaper.phoneId");
	var typeId = document.getElementById("wallpaper.typeId");
...
<body style="padding-top:5px;padding-bottom:3px;">
    <form id="form1" name="form1" method="post" action="${rootPath}/content/wallpaper/add.action" enctype="multipart/form-data" onSubmit=" return checkForm()">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="boxsearch">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="5" class="boxsearch">
           <tr>                          
              ...
              <td width="40%" align="left" nowrap="nowrap">
             	 <input class="input" type="text" name="wallpaper.title" id="wallpaper.title"/><font color=red>*</font>
	          </td>
           ...
           <tr>                          
              ...
              <td width="40%" align="left" nowrap="nowrap">
             	 <input class="input" type="text" name="wallpaper.price" id="wallpaper.price"/><font color=red>*</font>
	          </td>
              <td width="20%" align="left">&nbsp;</td>
             </tr>
            ...
            <tr>                          
              ...
              <td width="40%" align="left" nowrap="nowrap">
              <select name="wallpaper.phoneId"  id="wallpaper.phoneId">
            ...
            <tr>                          
              ...
              <td width="40%" align="left" nowrap="nowrap">
              <select name="wallpaper.typeId"  id="wallpaper.typeId">
	                <option value="">请选择背景分类...</option>
	                <#if wallpaperTypeList?exists && wallpaperTypeList.size() != 0>
			        <#list wallpaperTypeList as wallpaperTypeVo>
				        <option value="${wallpaperTypeVo.typeId?if_exists}">${wallpaperTypeVo.typeName?if_exists}</option>
			        </#list>
			        </#if>
	            </select> 
	            <font color=red>*</font>
      ...
      <tr>
        <td height="44" colspan="3" align="center" valign="middle" class="down">
         ...
         <INPUT class=denglu1 type=button value="返回列表" onclick="javascript:window.location.href ='${rootPath}/content/wallpaper/list.action';"/>
        </td>
      </tr>
    </table>
