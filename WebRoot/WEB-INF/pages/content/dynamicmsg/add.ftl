...
<body style="padding-top:5px;padding-bottom:3px;">
    <form id="addForm" name="addForm" method="post" action="${rootPath}/content/dynamicmsg/add.action" onSubmit="return checkForm();">
<table width="100%" height="99%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="94%" height="36" background="${rootPath}/images/main/all_t_bg.gif"><img src="${rootPath}/images/icon/baobiao.gif"><span class="title"><strong>动态消息管理</strong> -添加信息</span></td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="5" class="boxsearch">
        	<tr>                          
              ...
              <td width="30%" align="left" nowrap="nowrap">
             	 <input class="input" type="text" name="dynamicMsg.phoneNum" id="dynamicMsg.phoneNum"/><font color=red>*</font>
	          </td>
