...
<table width="100%" height="99%" border="0" cellspacing="0"
  ...
  <!-- 中间部分 -->
	<form id="editForm" name="editForm" method="post" action="${request.contextPath}/customer/saveTerUserGroup.action">
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="5"
			...
			<tr>
				...
				<td width="40%" align="left" nowrap="nowrap"><input
					class="input" type="text" id="terUserGroupVO.tgName" name="terUserGroupVO.tgName" /><font color=red>*</font></td>
