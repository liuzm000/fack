...
<script>
	function checkUpdateForm(){
		...
		document.forms["editForm"].action = "updateHotKeyword.action";
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>热门搜索词 - 更新</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
  				<tr>
					...
					<td width="30%" align="left" style="padding-left:10px">${vo.hkId?if_exists}
					<input id="hwModel.hkId" name="hwModel.hkId"  maxlength="50" size="60" type="hidden" value="${vo.hkId?if_exists}"/>
					</td>
				...
				<tr>
					...
					<input id="hwModel.keyword" name="hwModel.keyword"  maxlength="50" size="40" type="text" value="${vo.keyword?if_exists}"/>
					</td>
				...
				<tr>
					...
					<td width="30%" align="left" style="padding-left:10px">
					<input id="hwModel.keyDesc" name="hwModel.keyDesc"  maxlength="50" size="40" type="text" value="${vo.keyDesc?if_exists}"/>
					</td>
