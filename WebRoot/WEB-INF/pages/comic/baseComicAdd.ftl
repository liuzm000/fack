...
<form action="${request.contextPath}/comic/baseComicAdd.action" method="post" name="addForm">

<table width="100%" height="99%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="3%"  height="36"  align="left" background="../images/main/all_t_bg.gif"><img src="../images/main/all_t_l.gif" ></td>
    <td width="94%" height="36" background="../images/main/all_t_bg.gif"><img src="../images/icon/gl.gif"><span class="title">动漫管理 - 添加动漫基本信息</span></td>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="5" class="boxsearch2" >
         <tr>
          ...
          <tr>
            ...
            <td width="80%" align="left"><input name="name" type="text" id="name" size="50" maxlength="50">
              <font color="red">*</font></td>
            </tr>
          <tr>
            <td align="right">动漫类型：</td>
            <td align="left"><select name="type" id="type" class="select" >
              <option value="1" >连载漫画</option>
              <option value="2" >四格漫画</option>
            </select></td>					
          </tr>
          <tr>
            <td align="right">简介：</td>
            <td align="left"><textarea name="intro" cols="50" rows="3" id="intro" value=""></textarea>               
            <font color="red"> *</font></td>
          </tr>
        </table>      
          </td>
