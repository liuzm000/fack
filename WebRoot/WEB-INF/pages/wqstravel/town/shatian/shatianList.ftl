...
<script type="text/javascript">
	...
	function search(){
		document.forms["searchForm"].action = "getTownPictureList.action";
		document.forms["searchForm"].submit();
		
	}
	function add(){
		document.forms["searchForm"].action = "toAddTownPicture.action";
		document.forms["searchForm"].submit();
		
	}
	function toAddPicList(obj){
		document.forms["searchForm"].action = "toAddPicList.action?id="+obj;
		document.forms["searchForm"].submit();
		
	}
	
	function viewPicList(obj){
		document.forms["searchForm"].action = "viewPicList.action?id="+obj;
		document.forms["searchForm"].submit();
	...
	function del(obj){
		if(confirm("你确定要删除这条记录吗？")){
			document.forms["searchForm"].action = "doTownPictureDelete.action?id=" + obj;
			document.forms["searchForm"].submit();
		}
	}
</script>
...
<div class="top">
	...
	<img src="../images/icon/shuju.gif" /><span class="title">沙田画卷 - 列表</span>
</div>
<!-- TOP END -->
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listTab">
			...
			<#if pageList?exists>
				...
				<tr onMouseOver="this.className='row_over'" onMouseOut="this.className='row_out'">
					...
					<td align="center">${page.typeDesc?if_exists}</td>
					<td align="center">
					...
					<td align="center">
					<a href="javascript:viewPicList('${page.id?if_exists}')"><font color="blue"><u>查看画卷集</u></font></a>
					<a href="javascript:toAddPicList('${page.id?if_exists}')"><font color="blue"><u>修改</u></font></a>
