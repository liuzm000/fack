...
<script>
	function checkSaveForm(){
		...
		var contentImg = document.getElementById("townVideoFileUrl");
		if(contentImg.value == "" || contentImg.value == null){
			alert("请选择视频文件!");
			contentImg.focus();
			return;
		}
		var time = document.getElementById("videoModel.createTime");
		...
		document.forms["editForm"].action = "doTownVideoSave.action";
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>名镇视频管理 - 添加</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="80%" border="0" align="center" cellpadding="0" cellspacing="10" class="tab" >
				<tr>
					...
					<input id="videoModel.title" name="videoModel.title"  maxlength="50" size="40" type="text" value=""/>
					</td>
				...
				<tr>
					...
					<td width="30%" align="left" style="padding-left:10px">
					<input id="videoModel.author" name="videoModel.author"  maxlength="50" size="40" type="text" value=""/>
					</td>
					<td width="40%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td align="left" style="padding-left:10px">
					<input type="text" size="14" id="videoModel.createTime" name="videoModel.createTime" class="Wdate" value="" onFocus="WdatePicker({startDate:'%y-%M-01',readOnly:true})" size="40"/>
					</td>
					</td>
				</tr>
