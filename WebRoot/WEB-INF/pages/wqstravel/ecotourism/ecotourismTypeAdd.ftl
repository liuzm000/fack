...
<script>
  function checkSaveForm(){
	...
	var iconImg = document.getElementById("typeIconFileUrl");
	...
	document.forms["editForm"].action = "doEcotourismTypeSave.action";
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>生态旅游类型- 添加<font color="red">(*默认图片名为标题描述)</font></strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  		...
  		<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<td width="30%" align="left" style="padding-left:10px">
						<input id="typeName" name="typeName"  maxlength="50" size="40" type="text" value=""/>
					</td>
				...
				<tr>
					...
					<td align="left" style="padding-left:10px">
						<input type="file" name="typeIconFileUrl" id="typeIconFileUrl" size="21" onchange="document.getElementById('file_icon').value=this.value" class="text opacity">
