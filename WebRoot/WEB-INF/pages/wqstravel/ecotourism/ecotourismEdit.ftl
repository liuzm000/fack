...
<script>
  function checkSaveForm(){
   var descript = $("#descript");
	...
	document.forms["editForm"].action = "doEcotourismEdit.action";
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>生态旅游图片- 修改</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					<td width="20%" align="right" style="padding-right:10px"><b>图片标题<font color="red">*</font>：</b></td>
				...
				<tr>
					<td width="20%" align="right" style="padding-right:10px"><b>图片：</b></td>
				...
				<tr>
					...
					<td align="left" style="padding-left:10px">
						<input type="file" name="contentFileUrl" id="produceContentFileUrls_1" size="21" onchange="document.getElementById('file_1').value=this.value" class="text opacity">
