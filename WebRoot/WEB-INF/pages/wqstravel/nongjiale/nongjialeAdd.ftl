...
<title>${title?if_exists}添加餐馆</title>
...
<script>
	function checkSaveForm(){
		...
		$("#editForm").attr("action","doNongJiaLeAdd.action");
		$("#editForm").submit();
	}
</script>
<style type="text/css">
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>${title?if_exists}信息管理 - 增加</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<input id="name" name="nongJiaLeModel.name"   maxlength="50" size="60" type="text" value=""/>
					</td>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="address" name="nongJiaLeModel.addr"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="tele" name="nongJiaLeModel.tele"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
			</table>
