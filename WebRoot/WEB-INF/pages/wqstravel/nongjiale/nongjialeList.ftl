...
<title>${title?if_exists}信息管理</title>
...
<script type="text/javascript">
	function search(){
		document.forms["searchForm"].action = "getNongJiaLeList.action";
		document.forms["searchForm"].submit();
	}
	
	
	function add(){
		document.forms["searchForm"].action = "toAddNongJiaLe.action";
		document.forms["searchForm"].submit();
	...
	function del(obj){
		if(confirm("你确定要删除这条记录吗？")){
			document.forms["searchForm"].action = "doNongJiaLeDelete.action?id=" + obj;
			document.forms["searchForm"].submit();
		}
	}
	function edit(obj){
		document.forms["searchForm"].action = "toEditNongJiaLe.action?id=" + obj;
		document.forms["searchForm"].submit();
	}
</script>
...
<div class="top">
	...
	<img src="../images/icon/shuju.gif" /><span class="title">${title?if_exists}信息管理 - 列表</span>
</div>
<!-- TOP END -->
