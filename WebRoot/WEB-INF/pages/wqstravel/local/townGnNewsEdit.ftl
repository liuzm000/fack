...
<script>
	function checkSaveForm(){
		...
		document.forms["editForm"].action = "doTownGnNewsUpdate.action?typeId=3";
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>国内新闻 - 修改</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				...
				<tr>
					<td align="right" valign="top" style="padding-right:10px"><b>链接<font color="red">*</font>：</b></td>
					<td width="50%" align="left" style="padding-left:10px">
					<input id="msgModel.fileUrl" name="msgModel.fileUrl" value=${vo.fileUrl}  maxlength="50" size="60" type="text" value=""/>
					</td>
