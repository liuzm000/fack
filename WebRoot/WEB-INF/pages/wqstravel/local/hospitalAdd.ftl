...
<script>
	function checkSaveForm(){
		...
		$("#editForm").attr("action","doHospitalSave.action");
		$("#editForm").submit();
	}
</script>
<style type="text/css">
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>医疗服务 - 增加</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<input id="name" name="hospitalModel.name"   maxlength="50" size="60" type="text" value=""/>
					</td>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="address" name="hospitalModel.address"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="tele1" name="hospitalModel.tele1"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="tele2" name="hospitalModel.tele2"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="tele3" name="hospitalModel.tele3"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
