...
<script>
	function checkSaveForm(){
		...
		$("#editForm").attr("action","doTrafficReguSave.action");
		$("#editForm").submit();
	}
</script>
<style type="text/css">
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>交规信息 - 增加</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<input id="title" name="trafficReguModel.title"   maxlength="50" size="60" type="text" value=""/>
					</td>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input type="text" size="14" id="createTime" name="trafficReguModel.createTime" class="Wdate"   maxlength="50" size="60"  onFocus="WdatePicker({startDate:'%y-%M-01',readOnly:true})" size="40"/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="unit" name="trafficReguModel.unit"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
