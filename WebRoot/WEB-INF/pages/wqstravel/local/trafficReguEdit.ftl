...
<script>
	function checkSaveForm(){
		...
		$("#editForm").attr("action","doTrafficReguUpdate.action");
		$("#editForm").submit();
	}
</script>
<style type="text/css">
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>交规信息 - 修改</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<input id="contentStr" name="trafficReguModel.contentStr"  maxlength="50" size="60" type="hidden" value=""/>
  		<input  name="trafficReguModel.id"  maxlength="100" size="60" type="hidden" value="${model.id?if_exists}"/>
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<input id="title" name="trafficReguModel.title"   maxlength="50" size="60" type="text" value="${model.title?if_exists}"/>
					</td>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input type="text" size="14" id="createTime" name="trafficReguModel.createTime" value="${model.createTime?if_exists}" class="Wdate"   maxlength="50" size="60"  onFocus="WdatePicker({startDate:'%y-%M-01',readOnly:true})" size="40"/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="unit" name="trafficReguModel.unit"  maxlength="50" size="60" type="text" value="${model.unit?if_exists}"/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
