...
<script>
	function checkSaveForm(){
		...
		$("#editForm").attr("action","doBeautifulCountryEdit.action");
		$("#editForm").submit();
	}
</script>
<style>
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>美丽乡村信息 - 编辑</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<input type="hidden" name="countryId" value="${model.id?if_exists}" type="text"/>
  		<input type="hidden"  name="searchCountryName" value="${searchCountryName?if_exists}"   type="text" />
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<input id="countryName" name="countryName"   maxlength="50" size="60" type="text" value="${model.name?if_exists}"/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				
				<tr>
					<td width="20%" align="right" valign="top" style="padding-right:10px"><b>乡村图集：</b></td>
					<td align="left" style="padding-left:10px">
						...
						<#if model.videoIconPaths?exists>
							<tr>
								<td width="20%" align="right" valign="top" style="padding-right:10px"><b>乡村视频：</b></td>
								<td align="left" style="padding-left:10px">
									<#list model.videoIconPaths?split(",") as s>
										<img src="${rootPath}/download${s}" width="48" height="48"/>
									</#list>
								</td>
							</tr>
				...
				<tr>
					<td align="right" style="padding-right:10px"><b>内容图片1：</b></td>
					<td align="left" style="padding-left:10px">
				...
				<tr>
					...
					<td align="left" style="padding-left:10px">
					<textarea id="countryDesc" name="countryDesc"  maxlength="2000" cols="40" rows="10" >${model.descript?if_exists}</textarea>
					</td>
				...
				<tr>
					...
					<textarea id="countryContent" name="countryContent">${model.fileUrl?if_exists}</textarea>
					</td>
