...
<script>
	function checkSaveForm(){
		...
		var iconUrl = $("#hotelIconUrls_1");
		if(iconUrl.attr("value") == "" || iconUrl.attr("value") ==null) {
			alert("请至少填写一张餐馆内容图片");
			iconUrl.focus();
			return;
		}
		...
		$("#editForm").attr("action","doRestaurantSave.action");
		$("#editForm").submit();
	}
</script>
<style type="text/css">
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>餐馆信息管理 - 增加</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				...
				<tr>
					...
					<textarea id="contentStr" name="contentStr"></textarea>
					</td>
