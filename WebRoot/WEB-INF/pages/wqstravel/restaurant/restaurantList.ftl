...
<script type="text/javascript">
	function search(){
		document.forms["searchForm"].action = "getRestaurantList.action";
		document.forms["searchForm"].submit();
	}
	
	
	function add(){
		document.forms["searchForm"].action = "doRestaurantAdd.action";
		document.forms["searchForm"].submit();
		
	}
	function edit(obj){
		document.forms["searchForm"].action = "toEditRestaurant.action?id=" + obj;
		document.forms["searchForm"].submit();
	...
	function del(obj){
		if(confirm("你确定要删除这条记录吗？")){
			document.forms["searchForm"].action = "doRestaurantDelete.action?id=" + obj;
			document.forms["searchForm"].submit();
		}
	}
	function showDetail(obj){
		document.forms["searchForm"].action = "getRestaurantDetail.action?id=" + obj;
		document.forms["searchForm"].submit();
	}
</script>
...
<div class="top">
	...
	<img src="../images/icon/shuju.gif" /><span class="title">餐馆信息管理 - 列表</span>
</div>
<!-- TOP END -->
		...
		<div class="boxsearch2">
			...
			<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="">
				<tr>
					...
					<td width="10%" align="right">餐馆地址：</td>
					<td width="10%" align="left">
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listTab">
			...
			<#if pageList?exists>
				...
				<tr onMouseOver="this.className='row_over'" onMouseOut="this.className='row_out'">
					...
					<td align="center">${page.addr?if_exists}</td>
					<td align="center">${page.tele?if_exists}</td>
					<td align="center"><a style="cursor: pointer;" href="${rootPath}/download${page.htmlInfo?if_exists}"><font color="blue">查看</font></a></td>
					<td align="center">
					<a href="javascript:showDetail('${page.id?if_exists}')"><font color="red"><u>查看详细信息</u></font></a>
