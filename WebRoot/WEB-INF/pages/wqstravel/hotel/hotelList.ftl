...
<script type="text/javascript">
	function search(){
		document.forms["searchForm"].action = "getHotelList.action";
		document.forms["searchForm"].submit();
	}
	
	
	function add(){
		document.forms["searchForm"].action = "doHotelAdd.action";
		document.forms["searchForm"].submit();
	...
	function del(obj){
		if(confirm("你确定要删除这条记录吗？")){
			document.forms["searchForm"].action = "doHotelDelete.action?id=" + obj;
			document.forms["searchForm"].submit();
		}
	}
	function showDetail(obj){
		document.forms["searchForm"].action = "getHotelDetail.action?id=" + obj;
		document.forms["searchForm"].submit();
	}
	function edit(obj){
		document.forms["searchForm"].action = "toEditHotel.action?id=" + obj;
		document.forms["searchForm"].submit();
	}
</script>
...
<div class="top">
	...
	<img src="../images/icon/shuju.gif" /><span class="title">酒店信息管理 - 列表</span>
</div>
<!-- TOP END -->
