...
<script>
	function checkSaveForm(){
		...
		if(10==count){
			alert("请至少选择一张酒店内容图片!");
			var contentImag = document.getElementById("hotelIconUrls_1");
			contentImag.focus();
			return;
		}
		//--end--
        ...
        //alert(content);
		$("#editForm").attr("action","doHotelSave.action");
		$("#editForm").submit();
	}
</script>
<style type="text/css">
...
<body>
  ...
  <div class="topleft"></div>
    <img src="../images/icon/baobiao.gif"><span class="title"><strong>酒店信息管理 - 增加</strong></span>
  </div>
  <!-- 主体部分 -->
  <div class="tmiddle">&nbsp;
  	<div class="boxsearch">
  	...
  	<div class="boxsearch">
  		...
  		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tab">
				<tr>
					...
					<input id="name" name="hotel.name"   maxlength="50" size="60" type="text" value=""/>
					</td>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
					<input id="address" name="hotel.addr"  maxlength="50" size="60" type="text" value=""/>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				...
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType1" name="roomType1"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格<font color="red">*</font>：</b>
						<input id="price1" name="price1"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType2" name="roomType2"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price2" name="price2"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType3" name="roomType3"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price3" name="price3"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType4" name="roomType4"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price4" name="price4"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					...
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType5" name="roomType5"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price5" name="price5"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					<td width="20%" align="right" valign="top" style="padding-right:10px"><b>房间类型6：</b></td>
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType6" name="roomType6"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price6" name="price6"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					<td width="20%" align="right" valign="top" style="padding-right:10px"><b>房间类型7：</b></td>
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType7" name="roomType7"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price7" name="price7"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					<td width="20%" align="right" valign="top" style="padding-right:10px"><b>房间类型8：</b></td>
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType8" name="roomType8"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price8" name="price8"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					<td width="20%" align="right" valign="top" style="padding-right:10px"><b>房间类型9：</b></td>
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType9" name="roomType9"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price9" name="price9"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
				<tr>
					<td width="20%" align="right" valign="top" style="padding-right:10px"><b>房间类型10：</b></td>
					<td width="50%" align="left" style="padding-left:10px">
						<input id="roomType10" name="roomType10"  maxlength="25" size="30" type="text" value=""/>
						<b>房间价格  ：</b>
						<input id="price10" name="price10"  maxlength="10" size="15" type="text" value=""/><b>元</b>
					</td>
					<td width="30%" align="left" style="padding-left:20px"><font color="green"></font></td>
				</tr>
