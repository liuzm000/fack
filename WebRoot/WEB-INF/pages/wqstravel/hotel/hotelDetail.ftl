...
<div class="top">
	...
	<img src="../images/icon/shuju.gif" /><span class="title">酒店详细信息</span>
</div>
<!-- TOP END -->
...
<div class="tmiddle">&nbsp;
	<div class="tablebox">
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listTab">
			<tr>
				<td align="right" width="15%">酒店名称</td>
				<td align="center" width="85%">${hotel.name?if_exists}</td>
			</tr>
			<tr>
				<td align="right" width="15%">酒店地址</td>
			...
			<tr>
				<td align="right" width="15%">房间类型</td>
				<td align="center" width="85%">
					<#if roomTypeList?exists>
						<#list roomTypeList as roomType>
							${roomType.name?if_exists}/${roomType.price?if_exists}元
							<#if roomType_has_next>
								；
							</#if>
						</#list>
					</#if>
